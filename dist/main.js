...
/******/ (() => {
  ...
  \**************************************/
      /***/ (
        ...
        eval(
          "__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst list = document.getElementById('list-id');\r\nconst listContainer = document.getElementById('list-container');\r\n\r\nconsole.log(list);\r\nconst displayListUI = (data) => {\r\n  if (list) {\r\n    data.forEach((response) => {\r\n      const listItem = document.createElement('li');\r\n      listItem.innerText = `${response.user} : ${response.score}`;\r\n      list.appendChild(listItem);\r\n      listContainer.appendChild(list);\r\n    });\r\n  }\r\n};\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (displayListUI);\r\n\n\n//# sourceURL=webpack://leaderboard-list-app/./src/modules/displayListUI.js?"
        );
  ...
  \********************************/
      /***/ (
        ...
        eval(
          "__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _displayListUI_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./displayListUI.js */ \"./src/modules/displayListUI.js\");\n\r\n\r\nconst id = 'AVdkzz5AAIgs0R81WwJw';\r\nconst refresh = async () => {\r\n  // const id = localStorage.getItem('gameId');\r\n  const refreshBtn = document.getElementById('btn-refresh');\r\n  const listContainer = document.getElementById('list-id');\r\n\r\n  const data = await fetch(\r\n    `https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${id}/scores`\r\n  );\r\n\r\n  const response = await data.json();\r\n  console.log(response);\r\n  // refreshBtn.addEventListener('click', () => {\r\n    console.log(response.result);\r\n    listContainer.innerHTML = '';\r\n    (0,_displayListUI_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(response.result);\r\n  // });\r\n  return response;\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (refresh);\r\n\n\n//# sourceURL=webpack://leaderboard-list-app/./src/modules/refresh.js?"
        );
